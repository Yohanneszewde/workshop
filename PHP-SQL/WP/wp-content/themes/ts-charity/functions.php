...
function ts_charity_scripts() {
	...
	wp_add_inline_style( 'ts-charity-basic-style',$custom_css );
...
define('TS_CHARITY_PRO_DOC','https://www.themeshopy.com/demo/docs/ts-charity-pro/');
define('TS_CHARITY_FREE_DOC','https://themeshopy.com/demo/docs/free-charity/');
define('TS_CHARITY_CONTACT','https://wordpress.org/support/theme/ts-charity/','ts-charity');
define('TS_CHARITY_CREDIT','https://www.themeshopy.com/themes/free-charity-wordpress-theme/','ts-charity');
